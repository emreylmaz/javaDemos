...
public class BIHKPSPublicSoap
{
    ...
    public BIHKPSPublicSoap(){}

    public BIHKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BIHKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BIHExtendedSoapSerializationEnvelope envelope= new BIHExtendedSoapSerializationEnvelope(BIHExtendedSoapSerializationEnvelope.VER11);
