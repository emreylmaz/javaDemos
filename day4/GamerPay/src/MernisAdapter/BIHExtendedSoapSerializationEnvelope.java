...
public class BIHExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BIHDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new BIHStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BIHDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BIHDateTimeConverter dateTimeConverter = new BIHStandardDateTimeConverter();

    public BIHExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BIHExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BIHMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BIHHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BIHExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BIHHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
