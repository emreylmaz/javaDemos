...
public class JHLKPSPublicSoap
{
    ...
    public JHLKPSPublicSoap(){}

    public JHLKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public JHLKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        JHLExtendedSoapSerializationEnvelope envelope= new JHLExtendedSoapSerializationEnvelope(JHLExtendedSoapSerializationEnvelope.VER11);
